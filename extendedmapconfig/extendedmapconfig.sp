...
public Plugin myinfo = {
	...
	author      = "Milo, TF2C support added by Andrew Betson",
...
void createConfigFiles() {
	...
	createConfigFile("arena", TYPE_GAMETYPE, "Arena maps");
	createConfigFile("plr",	  TYPE_GAMETYPE, "Payload Race maps");
	createConfigFile("tc",    TYPE_GAMETYPE, "Territorial Control maps");
	createConfigFile("koth",  TYPE_GAMETYPE, "King of the Hill maps");
	createConfigFile("sd",    TYPE_GAMETYPE, "Special Delivery maps");

	createConfigFile("vip",   TYPE_GAMETYPE, "VIP maps");
	createConfigFile("vipr",  TYPE_GAMETYPE, "VIP Race maps");
	createConfigFile("dom",   TYPE_GAMETYPE, "Domination maps");
	createConfigFile("td",    TYPE_GAMETYPE, "Territorial Domination maps");
	createConfigFile("kotf",  TYPE_GAMETYPE, "King of the Flag maps");
