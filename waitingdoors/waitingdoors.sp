...
public Plugin myinfo =
{
	...
	author      = "stephanie, Nanochip, & Lange, TF2C support added by Andrew Betson",
...
public void TF2_OnWaitingForPlayersStart()
{
	...
	if (mode == TF2_GameMode_PL || mode == TF2_GameMode_ADCP || mode == TF2_GameMode_Arena || mode == TF2C_GameMode_VIP)
	{
